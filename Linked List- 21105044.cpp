...
//first we will create node class
class Node{
    public:
...
//THEN WE WILL MAKE A FUNCTION TO INSERT DATA AT END OF LINKED LIST
...
//THEN A FUNCTION TO INSERT DATA AT START OF LINKED LIST IS CREATED
...
int main(){
    ...
    cout<<"Doubly Linked list with family members as elements is shown :"<<endl;
    cout<<endl;
    display_from_start(head);
}

//Family members' doubly-linked list can be linked by sorting the doubly linked list according to age in descending order.By doing so we will get a doubly linked list in which older generation people will be close to head in double linked list and new generation people will be close to tail in doubly linked list.
